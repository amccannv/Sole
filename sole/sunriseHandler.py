...
# This class will handle the wake-up sunrise.
# Connects with Raspberry Pi upon scheduled
# Cron Job.
class SunriseHandler(object):
    ...
    def on(self, colour):
        print "Starting sunrise sequence"
        self.turnSunriseAlarm(True, colour)

    def off(self):
        print "Turning light off"
        self.turnSunriseAlarm(False)

    def turnSunriseAlarm(self, signal, colour = None):
        return True
        # """
